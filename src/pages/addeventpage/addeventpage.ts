...
export class AddeventpagePage {
  ...
  generateQrCodePDF() {
    ...
    this.firebaseProvider.addToMyBadges({
      name: this.eventQrCodeData.name,
      address: this.eventQrCodeData.address,
      startTime: this.eventQrCodeData.dates.startDate,
      endTime: this.eventQrCodeData.dates.endDate,
    });
